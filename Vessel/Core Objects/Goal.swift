...
let Goals: [Goal.ID: Goal] = [
    ...
    Goal.ID.IMMUNITY: Goal(id: Goal.ID.IMMUNITY.rawValue, name: NSLocalizedString("immunity", comment: "Type of goal"), nameWithArticle: NSLocalizedString("an immunity", comment: "Type of goal"), imageName: "Immunity", headerText: NSLocalizedString("Learn all about immunity and the impact that metrics such as vitamin c have on your immune system. This page can be used as an educational resource in order to expand your knowledge on how Vessel's metrics impact your immunity.", comment: ""), backgroundColor: Constants.vesselPoor),
