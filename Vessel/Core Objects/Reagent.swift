...
[Reagent.ID.PH: Reagent(name: NSLocalizedString("pH", comment: "Reagent Name"),
 ...
 Reagent.ID.HYDRATION: Reagent(name: NSLocalizedString("Hydration", comment: "Reagent name"),
            ...
            buckets: [Bucket(low: 1.0,
                             ...
                             score: 80.0,
                             evaluation: .high,
                             hint: BucketHint(title: NSLocalizedString("You’re over-hydrated", comment: ""),
                        ...
                        Bucket(low: 1.0015,
                                ...
                                score: 100.0,
                                evaluation: .good,
                               hint: BucketHint(title: NSLocalizedString("Your body is well hydrated", comment: ""),
                        ...
                        Bucket(low: 1.006,
                                 ...
                                 score: 80.0,
                                 evaluation: .low,
                               hint: BucketHint(title: NSLocalizedString("You're under hydrated", comment: ""),
                        ...
                        Bucket(low: 1.015,
                                 ...
                                 score: 20.0,
                                 evaluation: .veryLow,
                               hint: BucketHint(title: NSLocalizedString("You’re dehydrated", comment: ""),
 ...
 Reagent.ID.VITAMIN_C: Reagent(name: NSLocalizedString("Vitamin C", comment: "Reagent name"),
            ...
            buckets: [Bucket(low: 350,
                             ...
                             score: 100.0,
                              evaluation: .good,
                             hint: BucketHint(title: NSLocalizedString("Your Vitamin C level is great!", comment: ""),
                      ...
                      Bucket(low: 0.0,
                                       ...
                                       score: 20.0,
                                       evaluation: .low,
                             hint: BucketHint(title: NSLocalizedString("You’re low in Vitamin C", comment: ""),
 ...
 Reagent.ID.CORTISOL: Reagent(name: NSLocalizedString("Cortisol", comment: "Reagent name"),
            ...
            recommendedDailyAllowance: nil,
            imageName: "Cortisol",
            buckets: [Bucket(low: 150.0,
                             high: 405.0,
                                 score: 50.0,
                                 evaluation: .high,
                             hint: BucketHint(title: NSLocalizedString("Your Cortisol levels are high", comment: ""),
                      ...
                      Bucket(low: 50.0,
                             high: 150.0,
                                score: 100.0,
                                evaluation: .good,
                             hint: BucketHint(title: NSLocalizedString("Your Cortisol level is great!", comment: ""),
                      ...
                      Bucket(low: 0.0,
                                       ...
                                       score: 80.0,
                                       evaluation: .low,
                             hint: BucketHint(title: NSLocalizedString("Your Cortisol level is low.", comment: ""),
 ...
 Reagent.ID.LEUKOCYTE: Reagent(name: NSLocalizedString("Leukocyte", comment: "Reagent name"),
            ...
            recommendedDailyAllowance: nil,
            imageName: "UrinaryTract",
            buckets: [Bucket(low: 60.0,
                             high: 120.0,
                             score: 0.0,
                              evaluation: .detected,
                             hint: BucketHint(title: NSLocalizedString("PLACEHOLDER TEXT - POSITIVE LEUKOCYTE", comment: ""),
                                              description: NSLocalizedString("PLACEHOLDER DESCRIPTION - POSITIVE LEUKOCYTE", comment:""))),
                      Bucket(low: 0.0,
                                       high: 60.0,
                                       score: 0.0,
                                       evaluation: .notDetected,
                             hint: BucketHint(title: NSLocalizedString("PLACEHOLDER TEXT - NEGATIVE LEUKOCYTE", comment: ""),
 ...
 Reagent.ID.SODIUM: Reagent(name: NSLocalizedString("Sodium", comment: "Reagent name"),
            ...
            recommendedDailyAllowance: 0,
            imageName: "Sodium",
            buckets: [Bucket(low: 50.0,
                             high: 120.0,
                             score: 50.0,
                              evaluation: .high,
                             hint: BucketHint(title: NSLocalizedString("Your Sodium results are too high", comment: ""),
                      ...
                      Bucket(low: 0.0,
                                       ...
                                       score: 100.0,
                                       evaluation: .good,
                             hint: BucketHint(title: NSLocalizedString("Your Sodium results are good", comment: ""),
