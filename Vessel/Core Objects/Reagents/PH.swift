...
let PH = Reagent(
    ...
    goalSources: [
        ...
        GoalSources(goalID: .BODY, sources: [
            Source(url: "https://www.ncbi.nlm.nih.gov/pubmed/11842945/", text: NSLocalizedString("This paper reviews how the body compensates for acidic food by dissolving calcium and phosphorus in our bones, leading to lower bone density.", comment: "")),
