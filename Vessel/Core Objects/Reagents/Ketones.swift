    ...
    buckets: [
        ...
        Bucket(low: 0.0, high: 2.21, score: 0.0, evaluation: .ketoLow,
               hint: TitleDescription(
                ...
                variation: NSLocalizedString("Ketones can be beneficial for improved focus, healthy weight management, increased energy, and a balanced mood through increasing your metabolic machinery in your cells to more efficiently burn fat for fuel. Achieving a \"good\" or \"high\" ketone reading on your Vessel Wellness card requires increased attention to your diet. Ketones are produced when carbohydrate intake is very low, typically 20-50g/day, healthy fat intake is high, roughly 70% of caloric intake, and protein intake is moderate. Consume foods such as avocado, olive oil, salmon, hemp seeds and lean protein. Keep in mind that it can take several weeks to a month to increase ketone levels.", comment: "")))],
    goalImpacts: [
