...
struct AfterTestViewControllerData
{
    ...
    internal init(_ title: String, _ details: String, _ imageName: String, _ transition: ScreenTransistion, _ isHydroQuiz: Bool = false)
    {
        self.title = title
...
class AfterTestViewModel
{
    ...
    func setDailyWaterIntake(dailyDrinkedGlasses: Int)
    {
        ...
        {
            contact.dailyWaterIntake = dailyDrinkedGlasses
        }
