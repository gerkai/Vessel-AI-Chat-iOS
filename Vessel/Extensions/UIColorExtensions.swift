...
extension UIColor
{
    ...
    static var codGray = UIColor(hex: "#161514")
    static var transparentCodGray: UIColor { UIColor(hex: "#161514").withAlphaComponent(0.7) }
    static var disabledGrayColor: UIColor = UIColor(hex: "#191917")
    ...
    static var darkGrayText = UIColor(hex: "#5A5A57")
    ...
    static var gold = UIColor(hex: "FFC400")
    static var silver = UIColor(hex: "CCCCCC")
    static var bronze = UIColor(hex: "FBA068")
    static var blackAlpha7 = UIColor.black.withAlphaComponent(0.7)
    static var blackAlpha5 = UIColor.black.withAlphaComponent(0.5)
